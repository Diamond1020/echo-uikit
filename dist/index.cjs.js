...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 150 26" }, props),
        React__default['default'].createElement("image", { width: "150", height: "26", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewDark.png' })));
};
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/perseusdefi/",
            },
            {
                label: "Docs",
                href: "https://perseusdefi.gitbook.io/perseus-finance/",
            },
            {
                label: "Blog",
                href: "https://perseusfinance.medium.com/",
            },
        ],
    },
];
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/joinchat/Id7sXKJ0Xvw5ZTY0",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/EcoChainToken?s=09",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#04658e", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#00b187", textDisabled: "#BDC2C4", textSubtle: "#00b187", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(180deg, #09c8e6 0%, #0d4f59 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9764ef", background: "#f1f1f1", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#014636", text: "#00b187", textDisabled: "#666171", textSubtle: "#00b187", borderColor: "#524B63", card: "#ffffff", gradients: {
